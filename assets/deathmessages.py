death_messages = {
    "death.fell.accident.vines": f"{person1} fell off some vines",
    "death.fell.accident.weeping_vines": f"{person1} fell off some weeping vines",
    "death.fell.accident.twisting_vines": f"{person1} fell off some twisting vines",
    "death.fell.accident.scaffolding": f"{person1} fell off scaffolding",
    "death.fell.accident.other_climbable": f"{person1} fell while climbing",
    "death.fell.accident.generic": f"{person1} fell from a high place",
    "death.fell.killer": f"{person1} was doomed to fall",
    "death.fell.assist": f"{person1} was doomed to fall by {person2}",
    "death.fell.assist.item": f"{person1} was doomed to fall by {person2} using {item}",
    "death.fell.finish": f"{person1} fell too far and was finished by {person2}",
    "death.fell.finish.item": f"{person1} fell too far and was finished by {person2} using {item}",
    "death.attack.lightningBolt": f"{person1} was struck by lightning",
    "death.attack.lightningBolt.player": f"{person1} was struck by lightning whilst fighting {person2}",
    "death.attack.inFire": f"{person1} went up in flames",
    "death.attack.inFire.player": f"{person1} walked into fire whilst fighting {person2}",
    "death.attack.onFire": f"{person1} burned to death",
    "death.attack.onFire.player": f"{person1} was burnt to a crisp whilst fighting {person2}",
    "death.attack.lava": f"{person1} tried to swim in lava",
    "death.attack.lava.player": f"{person1} tried to swim in lava to escape {person2}",
    "death.attack.hotFloor": f"{person1} discovered the floor was lava",
    "death.attack.hotFloor.player": f"{person1} walked into danger zone due to {person2}",
    "death.attack.inWall": f"{person1} suffocated in a wall",
    "death.attack.inWall.player": f"{person1} suffocated in a wall whilst fighting {person2}",
    "death.attack.cramming": f"{person1} was squished too much",
    "death.attack.cramming.player": f"{person1} was squashed by {person2}",
    "death.attack.drown": f"{person1} drowned",
    "death.attack.drown.player": f"{person1} drowned whilst trying to escape {person2}",
    "death.attack.starve": f"{person1} starved to death",
    "death.attack.starve.player": f"{person1} starved to death whilst fighting {person2}",
    "death.attack.cactus": f"{person1} was pricked to death",
    "death.attack.cactus.player": f"{person1} walked into a cactus whilst trying to escape {person2}",
    "death.attack.generic": f"{person1} died",
    "death.attack.generic.player": f"{person1} died because of {person2}",
    "death.attack.explosion": f"{person1} blew up",
    "death.attack.explosion.player": f"{person1} was blown up by {person2}",
    "death.attack.explosion.player.item": f"{person1} was blown up by {person2} using {item}",
    "death.attack.magic": f"{person1} was killed by magic",
    "death.attack.magic.player": f"{person1} was killed by magic whilst trying to escape {person2}",
    "death.attack.even_more_magic": f"{person1} was killed by even more magic",
    "death.attack.wither": f"{person1} withered away",
    "death.attack.wither.player": f"{person1} withered away whilst fighting {person2}",
    "death.attack.witherSkull": f"{person1} was shot by a skull from {person2}",
    "death.attack.anvil": f"{person1} was squashed by a falling anvil",
    "death.attack.anvil.player": f"{person1} was squashed by a falling anvil whilst fighting {person2}",
    "death.attack.fallingBlock": f"{person1} was squashed by a falling block",
    "death.attack.fallingBlock.player": f"{person1} was squashed by a falling block whilst fighting {person2}",
    "death.attack.mob": f"{person1} was slain by {person2}",
    "death.attack.mob.item": f"{person1} was slain by {person2} using {item}",
    "death.attack.player": f"{person1} was slain by {person2}",
    "death.attack.player.item": f"{person1} was slain by {person2} using {item}",
    "death.attack.arrow": f"{person1} was shot by {person2}",
    "death.attack.arrow.item": f"{person1} was shot by {person2} using {item}",
    "death.attack.fireball": f"{person1} was fireballed by {person2}",
    "death.attack.fireball.item": f"{person1} was fireballed by {person2} using {item}",
    "death.attack.thrown": f"{person1} was pummeled by {person2}",
    "death.attack.thrown.item": f"{person1} was pummeled by {person2} using {item}",
    "death.attack.indirectMagic": f"{person1} was killed by {person2} using magic",
    "death.attack.indirectMagic.item": f"{person1} was killed by {person2} using {item}",
    "death.attack.thorns": f"{person1} was killed trying to hurt {person2}",
    "death.attack.thorns.item": f"{person1} was killed by {item} trying to hurt {person2}",
    "death.attack.trident": f"{person1} was impaled by {person2}",
    "death.attack.trident.item": f"{person1} was impaled by {person2} with {item}",
    "death.attack.fall": f"{person1} hit the ground too hard",
    "death.attack.fall.player": f"{person1} hit the ground too hard whilst trying to escape {person2}",
    "death.attack.outOfWorld": f"{person1} fell out of the world",
    "death.attack.outOfWorld.player": f"{person1} didn't want to live in the same world as {person2}",
    "death.attack.dragonBreath": f"{person1} was roasted in dragon breath",
    "death.attack.dragonBreath.player": f"{person1} was roasted in dragon breath by {person2}",
    "death.attack.flyIntoWall": f"{person1} experienced kinetic energy",
    "death.attack.flyIntoWall.player": f"{person1} experienced kinetic energy whilst trying to escape {person2}",
    "death.attack.fireworks": f"{person1} went off with a bang",
    "death.attack.fireworks.player": f"{person1} went off with a bang whilst fighting {person2}",
    "death.attack.fireworks.item": f"{person1} went off with a bang due to a firework fired from {item} by {person2}",
    "death.attack.badRespawnPoint": f"{person1} was killed by [Intentional Game Design]",
    "death.attack.sweetBerryBush": f"{person1} was poked to death by a sweet berry bush",
    "death.attack.sweetBerryBush.player": f"{person1} was poked to death by a sweet berry bush whilst trying to escape {person2}",
    "death.attack.sting": f"{person1} was stung to death",
    "death.attack.sting.player": f"{person1} was stung to death by {person2}"
}
